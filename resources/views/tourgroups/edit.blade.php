        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Update the Tour Group</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              <div class="card-body">
                <form action="/tourgroups/{{ $tourgroup->id }}" method="POST">
                    @csrf
                    @method('PUT')
                <div class="form-group">
                  <label for="exampleInputEmail1">Tourgroup Name</label>
                    <input type="text" value="{{ $tourgroup->tourgroup_name }}" name="tourgroup_name" class="form-control  @error('tourgroup_name')
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="{{ $tourgroup->tourgroup_country }}" name="tourgroup_country" class="form-control @error('tourgroup_country')
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $tourgroup->tourgroup_pax }}" name="tourgroup_pax" class="form-control @error('tourgroup_pax')
                ...
                <div class="form-group">
                  <label>Check In Date:</label>
                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" value="{{ $tourgroup->tourgroup_ci }}" name="tourgroup_ci" class="form-control @error('tourgroup_ci')
                ...
                <div class="form-group">
                  <label>Check Out Date:</label>
                    <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                        <input type="text" value="{{ $tourgroup->tourgroup_co }}" name="tourgroup_co" class="form-control @error('tourgroup_co')
