...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ __('Add new Ticket') }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">{{ __('Add new Ticket') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-body">
                            <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('ticket_location') }}" name="ticket_location"
                 ...
                 {{ 'is-invalid' }} @enderror " id="inputError" placeholder="Ticket Location">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('monument_name') }}" name="monument_name" class="form-control @error('monument_name')
                  ...
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" >
                                ...
                                <div class="form-group">
                                    <label>{{ __('Ticket Date') }}</label>
                                      <div class="input-group " id="reservationdate" data-target-input="nearest">
                                          <input type="text" value="{{ old('ticket_date') }}" name="ticket_date" class="form-control date @error('ticket_date')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('ticket_extra_info') }}"
                  ...
                  {{ 'is-invalid' }} @enderror" id="exampleInputEmail1" placeholder="Restaurant Extra Info">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select rounded-0" name="ticket_status"
                                        ...
                                        <option {{ old('ticket_status') == "Booked" ? "selected" : "" }}
